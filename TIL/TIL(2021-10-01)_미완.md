...
하지만 `header/nav/aside/footer`와 같이 **특정 위피나, 기능의 성향을 가지고 있는 요소는 내부에** `section/article`을 사용할 수 없다.       
...
<!-- - [x] [모바일버전 프로토타입 선정 && 구현해보기]() 
<br />
<img src="./images/웹디자인기능사_test_2.png" alt="" width="250px" height="px" style="padding-left: 40px;"/>
<br /> -->
