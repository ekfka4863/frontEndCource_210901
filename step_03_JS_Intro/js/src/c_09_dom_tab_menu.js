...
var titleArr = [].slice.call(titleList);   // li들... check! 
...
// ===========================================
// 이벤트처리
titleArr.forEach(function(element, index){    // 쌤: 클릭시 발생하는건 처음 forEach로 돌리는거고...
  // li 내부 버튼선택
...
*/
    ...
    // 선택된것, 선택되지 않은 것을 구분
    indexCheck = index;
    titleArr.forEach(function(el, idx){      // 이 forEach는 해당 배열요소를 모두 돌려야 하기 때문에 다시 반복수행하게 만들어야 ㅅ했고, 그역할을 위해 forEach가 중첩되서 하나 더 사용 되는것~
