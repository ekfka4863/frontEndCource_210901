...
// // 2. .year_part를 생성함과 동기에, (<h3>2021년도 이벤트</h3>) 를 생성 
// // 3. h3 뒤에 (<ul class="event_particle"></ul>) 생성 
// // 4. ul 내부에 li를 생성 및 각 기능에 따르는 추가 요소들을 처리
// //   <a href="" data-id="">
// //     <h4 class="event_title"></h4>
// //     <p class="event_narration"></p>
// //     <dl class="date"><dt class="blind"></dt><dd></dd></dl>
// //     <dl class="event_check success"><dt></dt><dd></dd></dl>
// //   </a>
...
// // var elContentInner = eventBox.querySelector(".content_inner");
// // // var eventInsertCode 
// // var EVENT_INSERT_CODE = '<a href="" data-id="">\
// //                           <h4 class="event_title"></h4>\
// //                           <p class="event_narration"></p>\
// //                           <dl class="date"><dt class="blind">기간</dt><dd></dd></dl>\
// //                           <dl class="event_check success"><dt>이벤트진행</dt><dd></dd></dl>\
// //                         </a>';
...
// // // var setYearPart = mkYearPart.setAttribute("class", "year_part on");
// // // mkYearPart.className = "year_part on";
...
// // // cf. Element.prepend();  -> 부모의 자식 요소로 추가되나 그 위치가 맨 뒤가 아닌 맨 앞에 추가되는 것이 append와 appendChild와는 다른점 
// // elContentInner.prepend(mkYearPart);


// // // 목록 생성 및 삽입 - li 
// // var yearPartList = eventData.eventList;
// // var partLen = yearPartList.length;    // li 갯수 파악 

// // var elEventParticle = elContentInner.querySelector(".event_particle");

// // // cf. 
// // // document.createElement(); 하기 귀찮으면 아래와 같이 함수로 만들어도 됨!
// // // var make = function(el, name) {
// // //   var mkEl = document.createElement(el);
// // //   mkEl.setAttribute("class", name);
// // //   return mkEl;
// // // };
// // // make("li", "box");    // <li class="box"></li>


// // // forEach 
// // // yearPartList.forEach(function(data, index) {
// // //   // var mkLi = document.createElement("li");
// // //   // console.log(data);   // title1  title2  title3

// // //   // 요소를 생성하고 클래스를 갖게 하는 기능의 함수 make()를 사용
// // //   var mkLi = make("li");
...
// // // ==========================================
// // // ==========================================
// // /* cf. DOM naming recommendation - by teacher
// // - el: 요소(element) 선택에 대한 변수 - e.g. elContentBox
// // - mk: 요소 생성에 대한 변수 - e.g. mkUl  (해석: make)
// // - ck: 단순한 값을 판단하는 변수 (해석: check)
// // - fn: 함수 선택하는 변수 
// // - Pascal case: 생성자 함수  
// // - 대문자로만 구성: string으로만 구성된 변수 - e.g. var CLASS_NAME = "on";  
// // - _: 임시용 지역변수  기타 (e.g. 지역변수 var boxFn = function(n) { var _data = n; };)
